...
public abstract class AwesomeRecvAdapter<T> extends RecyclerView.Adapter<RecyclerHolder> implements View.OnClickListener, DragSwipeAdapter {
    ...
    public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType){
        ...
        if(viewType == ITEMTYPE_LOADMORE) {
            ...
            if(mStaggeredGridLayoutManager != null) {
                ...
                ( (LinearLayout)mLoadingHolder.getView(R.id.recyc_item_tv_loadmore).getParent() )
    ...
    public void onClick(View v){
        if(v.getId() == R.id.recyc_item_tv_loadmore) {
            ...
            if(s.equals(
                    ( (TextView)mLoadingHolder.getView(R.id.recyc_item_tv_loadmore) ).getText().toString().trim())) {
                Log.d(TAG, "点击加载更多");
                mLoadingHolder
                        .setText(R.id.recyc_item_tv_loadmore, mContext.getString(R.string.jonas_recyc_loading_more));
