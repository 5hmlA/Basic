...
public class FlowLayout extends ViewGroup implements View.OnClickListener {
   ...
   public FlowLayout isSingleSelected(boolean singleSelecte){
   ...
   public FlowLayout addContent(String str, int strselector, int bgselector){
       addView(newCheckBox(str, strselector, bgselector));
       return this;
   }

   // 初始化条件布局
   private TextView newCheckBox(String name, int strselector, int bgselector){
       CheckedTextView box = new CheckedTextView(getContext());
       LayoutParams params = new LayoutParams(LayoutParams.WRAP_CONTENT, dip2px(28));
       box.setTextColor(ContextCompat.getColorStateList(getContext(), strselector));
       //        box.setButtonDrawable(new ColorDrawable(Color.TRANSPARENT));
       box.setLayoutParams(params);
       box.setBackgroundResource(bgselector);
       box.setTextSize(13);
       box.setText(name);
