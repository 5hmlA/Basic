...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<ImageView> {
    ...
    private void bindDimensions() {
        mAvatarMaxSize = mContext.getResources().getDimension(com.blueprint.R.dimen.image_width);
    }
    ...
    private void shouldInitProperties(ImageView child, View dependency) {
        ...
        if (mFinalXPosition == 0)
            mFinalXPosition = mContext.getResources().getDimensionPixelOffset(com.blueprint.R.dimen.abc_action_bar_default_height_material) + (mFinalHeight / 2);
