 ...
 * 具备miui弹簧效果
 */
public class JTopDampPanel extends CoordinatorLayout.Behavior<View> {
    ...
    public JTopDampPanel(){
        super();
    }

    public JTopDampPanel(Context context, AttributeSet attrs){
        super(context, attrs);
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, View child, View target){
        //        coordinatorLayout.getTag(R.id.jblue_damp_scroll_tag,) recycleview滑动速度  上滑动>0
    ...
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, View child, View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed){
        ...
        if(mDyUnconsumeds == 0) {
            ...
            if(mDyUnconsumeds>0) {
                Damping.push(target, mDamping);
                //target有可能在child里面
//                if(target.getParent() instanceof CoordinatorLayout) {
//                    hide(child);
//                }
            }else {
//                if(target.getParent() instanceof CoordinatorLayout) {
