...
public class SendCommentButton extends ViewAnimator implements View.OnClickListener {
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.jbasic_send_comment_button, this, true);
    }
    ...
    public void setCurrentState(int state) {
        ...
        if (state == STATE_DONE) {
            ...
            setInAnimation(getContext(), R.anim.jslide_in_done);
            setOutAnimation(getContext(), R.anim.jslide_out_send);
        } else if (state == STATE_SEND) {
            setEnabled(true);
            setInAnimation(getContext(), R.anim.jslide_in_send);
            setOutAnimation(getContext(), R.anim.jslide_out_done);
        }
        showNext();
    }
