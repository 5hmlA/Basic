...
public class JCimageView extends ImageView {
    ...
    private final Paint mBorderPaint = new Paint(Paint.ANTI_ALIAS_FLAG) {
        {
            setDither(true);
            setShadowLayer(1, 1, 1, mShaderColor);
        }
    };
    ...
    public JCimageView(Context context){
        super(context);
    }

    public JCimageView(Context context, AttributeSet attrs){
        this(context, attrs, 0);
    }

    public JCimageView(Context context, AttributeSet attrs, int defStyle){
