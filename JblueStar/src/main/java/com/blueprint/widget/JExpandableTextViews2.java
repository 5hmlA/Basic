 ...
 * ======================================
 */
public class JExpandableTextViews2 extends FrameLayout implements View.OnClickListener {
    ...
    public JExpandableTextViews2(Context context){
        super(context);
        mContext = context;
        init();
    }

    public JExpandableTextViews2(Context context, AttributeSet attrs){
        this(context, attrs, 0);
    }

    public JExpandableTextViews2(Context context, AttributeSet attrs, int defStyleAttr){
...
//        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec){
        ...
        if (needExpandable&&mShowPartTextView.getLayout().getText().toString().equals(mOrignPartshowString)) {
            //System.out.println(mOrignPartshowString.indexOf("…\uFEFF"));
            int parttextlength = mOrignPartshowString.indexOf("…");
    ...
    private String getShowpartTextString() {
        if (TextUtils.isEmpty(mOrignPartshowString)) {
    ...
    private void configWormTv(){
        if(Gravity.BOTTOM == mWormTvPosition) {
            setPadding(getPaddingLeft(), getPaddingTop(), getPaddingRight(), mPaddingBottom + getBottomOffset()+mSpacingAdd);
        }else {
        ...
        if(Gravity.BOTTOM == mWormTvPosition) {
            ...
            mWormTvBg.set(mWormTvCenter.x-wormWidth, mWormTvCenter.y-getBottomOffset()/2f,
                    mWormTvCenter.x+wormWidth, mWormTvCenter.y+getBottomOffset()/2f);
        }else {
    ...
    public JExpandableTextViews2 setMaxLines(int maxLines){
        mMaxLines = maxLines;
        configTextViews();
        return this;
    }

    public JExpandableTextViews2 setText(CharSequence content){
        mContent = content;
    ...
    public JExpandableTextViews2 setExpanded(boolean expanded){
        isExpanded = expanded;
        return this;
    }
    ...
    public JExpandableTextViews2 setSpacingAdd(int spacingAdd){
    ...
    public JExpandableTextViews2 setTextColor(int textColor){
     ...
     * @return
     */
    public JExpandableTextViews2 setTextSizePx(int textSize){
        this.mTextSize = textSize;
        configTextViews();
        return this;
    }

    public JExpandableTextViews2 setTextSize(int textSize){
    ...
    public JExpandableTextViews2 setLetterSpacing(float letterSpacing){
    ...
    public JExpandableTextViews2 setSpacingMult(float spacingMult){
    ...
    public JExpandableTextViews2 setWormTvSize(float wormTvSize){
    ...
    public JExpandableTextViews2 setHideMsg(String hideMsg){
        mHideMsg = hideMsg;
        return this;
    }
    ...
    public JExpandableTextViews2 setExpandMsg(String expandMsg){
    ...
    public JExpandableTextViews2 setWormTvPosition(int wormTvPosition){
    ...
    public JExpandableTextViews2 setBackColor(int backgroundColor){
    ...
    public JExpandableTextViews2 setTvAlpha(int tvAlpha){
    ...
    public JExpandableTextViews2 setWormTvColor(int wormTvColor){
        mWormTvColor = wormTvColor;
        mWormViewPaint.setColor(mWormTvColor);
        return this;
    }

    public JExpandableTextViews2 toggle(){
        if(needExpandable) {
    ...
    public JExpandableTextViews2 toggle1(){
        if(needExpandable) {
            isExpanded = !isExpanded;
            if(isExpanded) {
                mExpandTextView.setVisibility(VISIBLE);
    ...
    public JExpandableTextViews2 setAnimateable(boolean animateable){
