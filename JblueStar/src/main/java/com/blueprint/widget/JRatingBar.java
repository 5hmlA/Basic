...
import com.blueprint.helper.NumHelper;
...
public class JRatingBar extends View {
    ...
    protected void onDraw(Canvas canvas){
        ...
        if(mRating>1) {
            ...
            if(mRating-(int)( mRating ) == 0) {
                ...
                canvas.translate(starDistance+starWidth, 0);
                canvas.drawRect(0, 0, starWidth*( Math.round(( mRating-(int)( mRating ) )*10)*1.0f/10 ), starHeight,
                        mPaint);
            }
        }else {
    ...
    private void transforStepSize(){
        ...
        mRating = NumHelper.getCell(mRating*10, stept)/10f;
    }
