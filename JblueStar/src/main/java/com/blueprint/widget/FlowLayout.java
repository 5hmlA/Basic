...
public class FlowLayout extends ViewGroup implements View.OnClickListener {
    ...
    public void onClick(View v){
        if(v instanceof Checkable) {
            ...
            if(mListener != null) {
                //选中状态表示被点击
                mListener.onItemSelected(v, (Integer)v.getTag());
            }
        }
    }
    ...
    public FlowLayout clearAllSelectedIndex(){
        for(int i = 0; i<getChildCount(); i++) {
            Checkable childAt = (Checkable)getChildAt(i);
            if(childAt.isChecked()) {
    ...
    public FlowLayout setSingleSelected(boolean singleSelecte){
    ...
    public FlowLayout addContent(String... str){
        for(String s : str) {
    ...
    public FlowLayout addContent(List<String> str){
        for(String s : str) {
            addView(newCheckedItem(s));
        }
        return this;
    ...
    // 初始化条件布局
    private TextView newCheckedItem(String content){
    ...
    public FlowLayout setMaxCountEachLines(int count){
    ...
    public FlowLayout setOnItemSelectedListener(OnItemSelectedListener listener){
        mListener = listener;
        return this;
    }

    public FlowLayout setNeedExpend(boolean needExpend){
        mNeedExpend = needExpend;
        return this;
    }

    public FlowLayout setItemTvColor(@NonNull int itemTvColor){
        mItemTvColor = itemTvColor;
        return this;
    }

    public FlowLayout setItemTvColorSelector(@Size(value = 3) @ColorInt int... colors){
        mItemTvColorSelector = getColorStateList2(colors);
        return this;
    }

    public FlowLayout setItemLayoutParams(LayoutParams itemLayoutParams){
        mItemLayoutParams = itemLayoutParams;
        return this;
    }

    public FlowLayout setTextSize(int textSize){
        mTextSize = textSize;
        return this;
    }

    public FlowLayout setItemBgselector(@Size(value = 2) @DrawableRes int... resIds){
        mItemBgselector = getListDrable(resIds);
        return this;
    }

    public FlowLayout setItemBackgroundResource(int itemBg_ids){
