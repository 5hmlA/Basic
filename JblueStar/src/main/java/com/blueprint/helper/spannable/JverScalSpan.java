...
public class JverScalSpan extends ImageSpan {

    private float scale = 1.0f;

    public JverScalSpan(int resourceId){
        super(LibApp.getContext(), resourceId);
    }

    public JverScalSpan(Drawable drawable){
        super(drawable);
    }
    ...
    public int getSize(Paint paint, CharSequence text, int start, int end, Paint.FontMetricsInt fontMetricsInt){
        ...
        if(fontMetricsInt != null) {
            float lineHeight = fontMetricsInt.bottom-fontMetricsInt.ascent;
